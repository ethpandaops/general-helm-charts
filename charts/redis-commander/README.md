...
**Homepage:** <https://github.com/joeferner/redis-commander>
...
| customArgs | list | `[]` | Custom args for the redis-commander container |
| customCommand | list | `[]` | Command replacement for the redis-commander container |
...
| image.pullPolicy | string | `"IfNotPresent"` | redis-commander container pull policy |
| image.repository | string | `"rediscommander/redis-commander"` | redis-commander container image repository |
| image.tag | string | `"latest"` | redis-commander container image tag |
